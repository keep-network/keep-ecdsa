...
1. Fork https://github.com/keep-network/keep-ecdsa[`keep-network/keep-ecdsa`]
2. Clone your fork
3. Follow the
   link:README.adoc#getting-set-up[installation & build steps] in the  README.
...
* It passes the https://github.com/keep-network/keep-ecdsa/actions[continuous
  integration tests].
...
Keep uses https://github.com/keep-network/keep-ecdsa/actions[Github Actions] for
