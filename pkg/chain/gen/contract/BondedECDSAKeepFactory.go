...
func (becdsakf *BondedECDSAKeepFactory) MasterBondedECDSAKeepAddress() (common.Address, error) {
	var result common.Address
	result, err := becdsakf.contract.MasterBondedECDSAKeepAddress(
		becdsakf.callerOptions,
	)
...
func (becdsakf *BondedECDSAKeepFactory) MasterBondedECDSAKeepAddressAtBlock(
	blockNumber *big.Int,
) (common.Address, error) {
	var result common.Address
