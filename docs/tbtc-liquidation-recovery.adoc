...
`BeneficiaryAddress` can be provided as an extended public key described by https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki[BIP 32]. Following types are supported: 
`xpub`, `ypub` and `zpub`.
