...
.. https://github.com/keep-network/keep-ecdsa/blob/main/docs/run-keep-ecdsa.adoc#72-testnet[Documentation]
...
.. See https://github.com/keep-network/keep-ecdsa/blob/main/docs/run-keep-ecdsa.adoc#application[Application Configuration] for template.
.. Testnet contract addresses can be found https://github.com/keep-network/keep-ecdsa/blob/main/docs/run-keep-ecdsa.adoc#723-contracts[here].
...
- https://github.com/keep-network/keep-ecdsa/blob/main/docs/run-keep-ecdsa.adoc[Run Keep ECDSA]
