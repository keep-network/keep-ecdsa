...
describe("SLA calculator", () => {
    it('should return keygen SLA equal to 100% ' +
    ...
    it('should return keygen SLA less than 100% ' +
    ...
    it('should return N/A instead of keygen SLA ' +
    ...
    it('should return signature SLA equal to 100% ' +
    ...
    it('should return signature SLA less than 100% ' +
    ...
    it('should return N/A instead of signature SLA ' +
